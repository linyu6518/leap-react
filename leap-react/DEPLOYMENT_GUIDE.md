...
```dockerfile
FROM nginx:alpine
COPY dist/leap-react /usr/share/nginx/html
...
Upload `dist/leap-react/` contents to cloud hosting with SPA routing enabled.
